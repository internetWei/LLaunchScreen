#
# Be sure to run `pod lib lint LLaunchScreen.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LLaunchScreen.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'LLaunchScreen/Classes/**/*'
  
  # s.resource_bundles = {
  #   'LLaunchScreen' => ['LLaunchScreen/Assets/*.png']
  # }
